      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-3 py-1.5 bg-slate-900 text-white rounded-lg text-[10px] font-black shadow-sm transition-all uppercase tracking-widest"
          >
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-4 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-[10px] font-black shadow-sm transition-all uppercase tracking-widest"
          >
        ...
        <div className="flex flex-col lg:flex-row gap-3">
          ...
          <div className="relative flex-1 group">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-sm placeholder:text-slate-400 focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all shadow-xs outline-none"
            />
          </div>
