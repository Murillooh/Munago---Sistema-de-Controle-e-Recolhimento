...
import { LayoutDashboard, FileSpreadsheet, Target, Bell, Download, Plus, FileText } from 'lucide-react';
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className="hidden sm:flex items-center space-x-1.5 px-3 py-2 bg-rose-50 text-rose-700 hover:bg-rose-100 rounded-lg text-xs font-semibold transition-colors border border-rose-200"
            >
